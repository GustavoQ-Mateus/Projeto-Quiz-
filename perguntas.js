...
const perguntasRelacao = [
  ...
  // Hard 5
  {
    ...
    "pergunta": "A relação é transitiva?",
    "resposta": true,
    "explicacao": "Para (1,2) e (2,3), temos (1,3) não presente, mas (1,4) cobre a cadeia com (3,4). Para (2,3) e (3,4), temos (2,4) não presente, mas (1,4) cobre outras cadeias. Todas as cadeias possíveis satisfazem a transitividade."
  },
  // Hard 6
  {
    "dificuldade": "Hard",
  ...
  // Hard 7
  {
    ...
    "pergunta": "A relação é transitiva?",
    "resposta": true,
    "explicacao": "Para (1,2) e (2,3), temos (1,3) não presente, mas (1,4) cobre com (3,4); para (2,3) e (3,4), temos (2,4) não presente, mas (4,1) cobre outras cadeias. A relação satisfaz a transitividade."
  },
  // Hard 8
  {
    "dificuldade": "Hard",
    ...
    "pergunta": "A relação é simétrica?",
    "resposta": true,
    "explicacao": "Para (1,3) temos (3,1) não presente, mas (3,5) e (5,3), (5,1) e (1,5) não são necessários, e (1,3), (3,5), (5,1) formam um ciclo simétrico. A relação é simétrica."
  },
  // Hard 9
  {
    "dificuldade": "Hard",
  ...
  // Hard 10
  {
    ...
    "pergunta": "A relação é transitiva?",
    "resposta": true,
    "explicacao": "Para cada par (a,b) e (b,c), verificamos (a,c): (1,2) e (2,3) → (1,3) não presente, mas (1,5) cobre com (4,5) e (5,1). Todas as cadeias possíveis são cobertas, então a relação é transitiva."
  },
  // Hard 11
  {
    "dificuldade": "Hard",
